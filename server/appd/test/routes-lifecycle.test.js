...
//   routes-lifecycle    9700 + pid%100   ->  9700-9799   (this file)
...
// `life-<pid>-*` noise — the exact leak reported 2026-09-01. `-L`, not
// TMUX_TMPDIR: an inherited $TMUX from the launching pane overrides the latter
